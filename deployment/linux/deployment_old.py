...
def create_linux_scheduled_task():
    pass


def create_macos_scheduled_task():
    pass
...
def main():
    ...
    if changes_detected:
        ...
        if current_platform == "Windows":
            install_dir = deploy_on_windows()

            create_windows_scheduled_task()
        elif current_platform == "Linux":
            install_dir = deploy_on_linux()

            create_linux_scheduled_task()
        elif current_platform == "Darwin":
            install_dir = deploy_on_mac()

            create_macos_scheduled_task()
        else:
